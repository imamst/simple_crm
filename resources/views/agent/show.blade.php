            ...
            <div class="user-profile layout-spacing">
                <div class="widget-content widget-content-area">
                    ...
                    <div class="text-center user-info">
                        @if($agent->photo != null)
                            <img src="{{asset('storage/'.$agent->photo)}}" alt="avatar">
                        @else
            ...
            <div class="widget widget-activity-three widget-activity-four">
                ...
                <div class="widget-content">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{route('agents.contracts.index', $agent->national_id)}}" class="btn btn-primary">View All <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></a>
                    </div>
                </div>
            </div>
